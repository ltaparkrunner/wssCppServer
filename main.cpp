...
// ОБЯЗАТЕЛЬНО: Подключаем заголовки AWS S3 до объявления сессий
#include <aws/core/Aws.h>
#include <aws/s3/S3Client.h>
#include <aws/s3/model/PutObjectRequest.h>

// Подключаем наши внутренние заголовочные файлы
#include "config.hpp"
#include "database.hpp" // Теперь тут нет дубликата структуры Config
#include "auth_utils.hpp"
#include "aux_handler.hpp"
//  #include "image.pb.h"    // Сгенерированный Protobuf заголовок
